...
<nav class="main-header navbar navbar-expand-md navbar-dark navbar-maroon">
    <div class="container">
      ...
      <img src="<?= base_url('assets/logo.jpeg') ?>"  class="img-size-50 mr-3 img-circle"
      style="opacity: .8">
        <!-- <i class="fas fa-store text-primary" style="opacity: .8"> </i> -->
        <span class="brand-text font-weight-light"><b> Wardoyo Jaya Aki</b></span>
      </a>
      ...
      <div class="collapse navbar-collapse order-3" id="navbarCollapse">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a href="<?= base_url('tentang_kami') ?>" class="nav-link">Tentang Kami</a>
          </li>

          <li class="nav-item">
            <a href="<?= base_url('hubungi_kami') ?>" class="nav-link">Hubungi Kami</a>
          </li>
        ...
        <li class="nav-item">
          <?php if ($this->session->userdata('email') == "")  { ?>
            <a class="nav-link" href="<?= base_url('pelanggan/login') ?>">
                ...
                <img src="<?= base_url('assets/gambar/pp.jpg') ?>" alt="Foto Profil" class="brand-image img-circle elevation-3"
                style="opacity: .8">
            </a>
          ...
          <?php } else { ?>
            <a class="nav-link" data-toggle="dropdown" href="#">
                ...
                <img src="<?= base_url('assets/foto_profil/' . $this->session->userdata('foto_profil')) ?>" alt="Foto Profil" class="brand-image img-circle elevation-3"
                style="opacity: .8">
            </a>
